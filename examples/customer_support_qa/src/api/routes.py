...
class SupportQARestApi(RestApi):
    ...
    def _register_routes(self) -> None:
        """Register customer support Q&A routes."""

        @self.router.post("/support/ask", response_model=SupportResponse)
        async def ask_question(request: SupportRequest) -> SupportResponse:
        ...
        @self.router.get("/support/{session_id}", response_model=dict)
        ...
        @self.router.get("/support/sessions/list", response_model=list)
