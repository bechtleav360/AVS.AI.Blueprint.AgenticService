...
def run(args: Namespace) -> None:
    ...
    try:
        ...
        print("\nCreated:")
        print("  .windsurf/rules/      - Always-on context rules")
        print("  .windsurf/workflows/  - Slash-command workflows")
        print("\nYou can now use Windsurf Cascade with:")
        print("  - Automatic context from rules")
        print("  - Slash commands like /create-handler")
