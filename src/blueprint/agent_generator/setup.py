...
def create_basic_config(name: str) -> dict:
    ...
    return {
        ...
        "agent_layer": {
            f"{name}Agent":
                {
                    "runtime_name": f"{PartGeneratorBase.camel_to_snake(name)}_agent"
                }
        },
        "service_layer": {
            f"{name}Service":
                {
                    ...
                    "process_function": {
                        ...
                        "input_type": f"{name}Model",
                        "output_type": f"{name}Model"
                    }
                }
        },
        "domain_models": {
