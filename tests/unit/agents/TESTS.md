...
`src/blueprint/agents/entrypoint.py` -- plus the frozen compatibility suite, which is about the
framework as a whole and therefore belongs to no single package.
