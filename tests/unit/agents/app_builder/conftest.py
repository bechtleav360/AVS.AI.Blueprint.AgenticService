...
def all_build_mocks():
    ...
    with (
        ...
        patch("blueprint.agents.app_builder.SessionsApiClient") as sessions_api_client,
        patch("blueprint.agents.app_builder.SessionKeyProvider") as session_key_provider,
        patch("blueprint.agents.app_builder.SessionsBus") as sessions_bus,
        ...
        yield types.SimpleNamespace(
            ...
            sessions_api_client=sessions_api_client,
            session_key_provider=session_key_provider,
            sessions_bus=sessions_bus,
            root_api=root_api,
            cache_api=cache_api,
            fastapi=fastapi,
        )
