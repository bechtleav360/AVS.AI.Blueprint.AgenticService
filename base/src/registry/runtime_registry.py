...
class RuntimeRegistry:
    """Registry for managing agent runtimes in the application."""
    ...
    async def process_with_runtime(
        ...
        **context_kwargs
        ...
        """
        with tracer.start_as_current_span("runtime_registry.process_with_runtime") as span:
            ...
            logger.info(
                ...
                extra={
                    ...
                    "context_keys": list(context_kwargs.keys()) if context_kwargs else []
                }
            )
    ...
    async def health_check_all(self) -> Dict[str, Dict[str, Any]]:
        ...
        with tracer.start_as_current_span("runtime_registry.health_check_all") as span:
            ...
            span.set_attribute("runtimes.healthy_count", 
